...
func TestUnionExpressionOrdering(t *testing.T) {
	...
	xpathExpr := `//div[@id]/span[@class] | //div/@data-type`
...
func TestNestedUnionPredicates(t *testing.T) {
	...
	xpathExpr := `(//div[@class='a'] | //p[@class='a']) | (//div[@class='b'] | //p[@class='b'])`
...
func TestStringConcatenationBasic(t *testing.T) {
	...
	xpathExpr := `//div[@data-value = concat(//div[@data-prefix][1]/@data-prefix, //div[@data-suffix][1]/@data-suffix)]`
...
func TestStringConcatenationLimitations(t *testing.T) {
	...
	xpathExpr := `//div[@data-result = concat(//span[@data-a]/@data-a, '-world')]`
